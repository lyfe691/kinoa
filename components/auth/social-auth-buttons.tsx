  ...
  return (
    <div className="space-y-3">
      <Button
        type="button"
        variant="outline"
        className="h-11 w-full justify-start gap-3 border-muted-foreground/20 bg-background/60 text-foreground shadow-sm"
        disabled={loadingProvider !== null}
        onClick={() => handleOAuth("github")}
      >
        <Github className="h-4 w-4" />
        <span className="font-medium">{actionLabel} with GitHub</span>
      </Button>
      ...
      <Button
        type="button"
        variant="outline"
        className="h-11 w-full justify-start gap-3 border-muted-foreground/10 bg-muted/60 text-muted-foreground"
        disabled
      >
        <ShieldCheck className="h-4 w-4" />
        <span className="font-medium">Continue with SSO</span>
        <span className="ml-auto rounded-full bg-background/60 px-2 text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">
          Soon
        </span>
      </Button>
    </div>
