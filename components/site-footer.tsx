      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="flex flex-col gap-5">
          ...
          <div className="space-y-2.5 text-xs leading-relaxed text-muted-foreground sm:text-sm">
            <p>
              Kinoa is a metadata discovery platform. We do not host, upload, or
              store audiovisual files. All playback is delivered directly by
              independent third-party hosters.
            </p>
            <p>
              Metadata is provided by public APIs. Kinoa does not control or
              guarantee external streams and assumes no responsibility for their
